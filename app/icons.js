// Modern Lucide-style stroke icons (24 viewBox).
// CSP-safe: inline SVG only — no external fetches.
// Same key names as before so call sites keep working.
window.LucideIcons = (() => {
  const attrs =
  ...
  const s = (paths) => `<svg ${attrs}>${paths}</svg>`;
  ...
  return {
    ...
    alertTriangle: s(`<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>`),
    target: s(`<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>`),
    brain: s(`<path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M12 18v-4"/>`),
    messageSquare: s(`<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>`),
    // Brain + spark for Ask AI mark
    askAi: s(`<path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M12 18v-4"/><path d="M20 3v3"/><path d="M21.5 4.5h-3"/>`),

    // Navigation
    home: s(`<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>`),
    calendar: s(`<path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/><path d="M16 18h.01"/>`),
    ...
    // Chat-style upward arrow (matches shared send glyph)
    send: s(`<path d="m5 12 7-7 7 7"/><path d="M12 19V5"/>`),
    collapse: s(`<path d="m15 18-6-6 6-6"/>`),
    ...
    fileWord: s(`<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="m8 16 2-6 2 6 2-6 2 6"/>`),
    message: s(`<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>`),
    messages: s(`<path d="M14 9a2 2 0 0 1-2 2H6l-4 4V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2z"/><path d="M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1"/>`),
    check: s(`<path d="M20 6 9 17l-5-5"/>`),
    listChecks: s(`<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/>`),
    ...
    key: s(`<path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4"/><path d="m21 2-9.6 9.6"/><circle cx="7.5" cy="15.5" r="5.5"/>`),
    ...
    cube: s(`<path d="m21.12 6.4-8.6-4.58a2 2 0 0 0-2 0L1.88 6.4a2 2 0 0 0-1 1.73v7.74a2 2 0 0 0 1 1.73l8.6 4.58a2 2 0 0 0 2 0l8.6-4.58a2 2 0 0 0 1-1.73V8.13a2 2 0 0 0-1-1.73z"/><path d="M12 22V12"/><path d="m3.4 6.96 8.6 4.58 8.6-4.58"/>`),
    plus: s(`<path d="M5 12h14"/><path d="M12 5v14"/>`),
    square: s(`<rect x="6" y="6" width="12" height="12" rx="1.5" fill="currentColor" stroke="none"/>`),
    barChart: s(`<line x1="12" x2="12" y1="20" y2="10"/><line x1="18" x2="18" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="14"/>`),
    ...
    mail: s(`<rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"/>`),
    highlighter: s(`<path d="m9 11-6 6v3h9l3-3"/><path d="m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4"/>`),
    meet: s(`<path d="M2 3h20"/><path d="M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3"/><path d="m7 21 5-5 5 5"/>`),
    ...
    focus: s(`<circle cx="12" cy="12" r="3"/><path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/>`),
    panelRight: s(`<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M15 3v18"/>`),
    share: s(`<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8.59 13.51 6.83 3.98"/><path d="m15.41 6.51-6.82 3.98"/>`),
    ...
    shieldCheck: s(`<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>`),
    chevronDown: s(`<path d="m6 9 6 6 6-6"/>`),
    duplicate: s(`<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>`),
  };
})();

window.icon = function (name, size = 18) {
  const svg = window.LucideIcons[name] || window.LucideIcons.sparkles;
  return `<span class="icon-wrap" style="width:${size}px;height:${size}px">${svg}</span>`;
};
