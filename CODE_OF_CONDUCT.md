...
AfterMeet community a harassment-free experience for everyone, regardless of
...
* Sharing API keys, personal meeting transcripts, or other secrets in issues or PRs
...
Report incidents to the maintainers via a **private** GitHub Security advisory
or by contacting the Code Owners listed in [`.github/CODEOWNERS`](.github/CODEOWNERS)
(replace placeholders with real handles once the repo is public).
